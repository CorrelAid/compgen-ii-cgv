...
select g1.textual_id, g1.longitude, g1.latitude, p1.content, coord.id, coord.version, coord.center_latitude, coord.center_longitude
from gov_item g1 
	inner join property p1
		on g1.id = p1.gov_object 
	inner join coordinate_index coord
		on g1.id = coord.gov_item
where g1.deleted = 0 
