...
loc_list_1 = ['Berlin', 'Berlinchen']
loc_list_2 = ['Berlinchen']

lc1 = LocCorrection(loc_list_1)
lc2 = LocCorrection(loc_list_2)

print(lc1.search('berlyn', 5))
print(lc2.search('berlyn', 5))
print(lc2.search('berlyn', 3))
